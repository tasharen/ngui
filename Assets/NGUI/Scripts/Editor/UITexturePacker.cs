...
public class UITexturePacker 
{
    ...
    public static Rect[] PackTextures(Texture2D texture, Texture2D[] textures, int width, int height, int padding, int maxSize) 
	{
        ...
        for(int i = 0; i < textures.Length; i++) 
		{
            ...
            Rect rect = bp.Insert(tex.width + twoPadding, tex.height + twoPadding, UITexturePacker.FreeRectChoiceHeuristic.RectBestAreaFit);
		...
		for(int i = 0; i < textures.Length; i++) 
		{
            ...
            if(rect.width != tex.width + twoPadding) 
			{
            ...
            texture.SetPixels((int)rect.x + padding, (int)rect.y + padding, (int)rect.width - twoPadding, (int)rect.height - twoPadding, colors);
            rect.x /= width;
            rect.y /= height;
            rect.width /= width;
            rect.height /= height;
