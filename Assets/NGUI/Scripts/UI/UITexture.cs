...
public class UITexture : UIWidget
{
	...
	public bool hasDynamicMaterial { get { return mMat != null; } }
	...
	public override Material material
	{
		...
		set
		{
			if (mMat != value && mMat != null)
			{
				NGUITools.Destroy(mMat);
				mMat = null;
			}
			mPMA = -1;
		}
	...
	void OnDestroy () { NGUITools.Destroy(mMat); }
